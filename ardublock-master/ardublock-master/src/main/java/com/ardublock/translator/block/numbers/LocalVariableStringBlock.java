...
public class LocalVariableStringBlock extends TranslatorBlock
{
	public LocalVariableStringBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
