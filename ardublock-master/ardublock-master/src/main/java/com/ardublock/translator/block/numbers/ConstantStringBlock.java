...
public class ConstantStringBlock extends TranslatorBlock
{
	public ConstantStringBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
