...
public class VariableFileBlock extends TranslatorBlock
{
	public VariableFileBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
