...
public class ReadNumberArrayBlock extends TranslatorBlock
{
	public ReadNumberArrayBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
