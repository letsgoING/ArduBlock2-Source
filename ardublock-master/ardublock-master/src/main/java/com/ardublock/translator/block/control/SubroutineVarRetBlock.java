...
public class SubroutineVarRetBlock extends TranslatorBlock
{
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");

	public SubroutineVarRetBlock(Long blockId, Translator translator,
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		TranslatorBlock translatorBlock_return = getRequiredTranslatorBlockAtSocket(3);
