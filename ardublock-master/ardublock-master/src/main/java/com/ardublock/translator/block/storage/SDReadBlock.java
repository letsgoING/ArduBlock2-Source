...
public class SDReadBlock extends TranslatorBlock
{
	public SDReadBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
