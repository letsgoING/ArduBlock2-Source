...
public class VariableCharBlock extends TranslatorBlock
{
	public VariableCharBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
