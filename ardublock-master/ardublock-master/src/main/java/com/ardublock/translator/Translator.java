...
//TEST*********************************************************************************
	public String translate(Set<RenderableBlock> loopBlocks, Set<RenderableBlock> subroutineBlocks, Set<RenderableBlock> interruptBlocks) throws SocketNullException, SubroutineNotDeclaredException
	{
...
//TEST*********************************************************************************
/*		for (RenderableBlock renderableBlock : interruptBlocks)
		{
			Block interruptBlock = renderableBlock.getBlock();
			code.append(translate(interruptBlock.getBlockID()));
		}*/
//TEST*********************************************************************************
