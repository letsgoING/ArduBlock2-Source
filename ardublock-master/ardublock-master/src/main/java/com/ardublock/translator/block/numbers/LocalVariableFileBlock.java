...
public class LocalVariableFileBlock extends TranslatorBlock
{
	public LocalVariableFileBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
