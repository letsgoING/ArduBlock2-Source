...
public class LGIQtouchSliderInitBlock extends TranslatorBlock
{
	  ...
	  public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	  {
	    ...
	    pin1 = translatorBlock.toCode().replaceAll("\\s*_.new\\b\\s*", "");
	    
	    translatorBlock = this.getRequiredTranslatorBlockAtSocket(1);
	    pin2 = translatorBlock.toCode().replaceAll("\\s*_.new\\b\\s*", "");
	    
	    translatorBlock = this.getRequiredTranslatorBlockAtSocket(2);
	    pin3 = translatorBlock.toCode().replaceAll("\\s*_.new\\b\\s*", "");
