...
public class SerialPrintBaudBlock extends TranslatorBlock
{
	public SerialPrintBaudBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
