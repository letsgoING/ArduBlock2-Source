...
public class SubroutineVarRetBlock_legacy extends TranslatorBlock
{
	private static ResourceBundle uiMessageBundle = ResourceBundle.getBundle("com/ardublock/block/ardublock");

	public SubroutineVarRetBlock_legacy(Long blockId, Translator translator,
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		TranslatorBlock translatorBlock_var = getRequiredTranslatorBlockAtSocket(0);
		var = translatorBlock_var.toCode().replaceAll("\\s*_.new\\b\\s*", "");
		TranslatorBlock translatorBlock = getTranslatorBlockAtSocket(1);
		TranslatorBlock translatorBlock_return = getRequiredTranslatorBlockAtSocket(2);
		...
		ret +=  "return "+ translatorBlock_return.toCode().replaceAll("\\s*_.new\\b\\s*", "") +";\n }\n";
		return ret;
	}
}
